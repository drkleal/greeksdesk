...
gammaButton.addEventListener('click',async()=>{
 ...
 gammaButton.disabled=true;out.textContent='Fetching one Gamma sample…';table.replaceChildren();
 try{
 ...
 }catch{out.textContent='Unable to load the sample. No automatic retry was made.';}finally{gammaButton.disabled=!slotSelect.value;}
});
