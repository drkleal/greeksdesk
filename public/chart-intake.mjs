...
export const chartSlots=[{id:'paste-dg',title:'DeepGamma · DG',hint:'Gamma levels and regime'},{id:'es-snapshot',title:'DeepCharts · DC',hint:'ES price structure and session levels'},{id:'paste-vp',title:'Volume Profile · VP',hint:'POC, value area, HVN, LVN and VWAP'}];
