export function isChart(url){try{const u=new URL(url);if(u.protocol!=='https:'||u.username||u.password)return false;return (u.hostname==='v3.quantdata.us'&&u.pathname.startsWith('/page/'))||(u.hostname==='app.optionsdepth.com'&&['/dashboard','/market-makers','/positional-insight','/depth-view','/iv-depth'].includes(u.pathname.replace(/\/$/,'')));}catch{return false;}}
