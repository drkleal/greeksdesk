...
export function createServer(password = process.env.DESK_PASSWORD) {
  ...
  return http.createServer(async (req, res) => {
    ...
    for(const asset of ['workbench.mjs','confluence.mjs','workbench.css','chart-intake.mjs','level-board.mjs','straddle.mjs','straddle-panel.mjs','verification.mjs','level-brief.mjs','exposure-display.mjs'])scripts['/'+asset]='./public/'+asset;
