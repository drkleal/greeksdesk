...
export const analysisSchema=obj({
 ...
 panels:arr(obj({id:str,sourceId:str,title:str,instrument:str,observedDate:str,status:{type:"string",enum:["usable","context","excluded"]},reason:str,shows:str,region:obj({x:{type:"number"},y:{type:"number"},width:{type:"number"},height:{type:"number"}})})),
